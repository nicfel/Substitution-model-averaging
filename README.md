---
author: David A. Rasmussen,Carsten Magnus,Remco Bouckaert (Adapted by Nicola Müller for SISMID)
beastversion: 2.x
title: Substitution-model-averaging (SISMID version)
level: Intermediate
beastversion: 2.6.x
tracerversion: 1.7.0
...
We will continue analyzing influenza A/H1N1 sequence data sampled over several years.
All the sequences are from the hemagglutinin (HA) segment.
...
First, we will need to tell BEAST to consider the different codon positions separately.
To do so, click the alignment and the split and choose 1+2+3.
This will consider the first, second and third codon position separately.
...
Next, go to Tip Dates and click use tip dates.
Set `as dates with format` to `yyyy-M-dd` and click `Auto-configure`.
Then, select use everything after Last as in the figure below

<figure>
	<a id="fig:partitions"></a>
	<img style="width:80.0%;" src="figures/sampling_dates.png" alt="">
	<figcaption>Figure 3: Select use everything after last to set the sampling dates.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 4: Setting up the BEAST ModelTest.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 5: Running the analysis in BEAST.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 6: Visualizing how the Markov chain explored different models in Tracer.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 7: A list of substitution models, their associated model number (index) and how the substitution rates are grouped.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 8: Visualizing the posterior support for different substitution models in Tracer.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 9: The posterior support for including gamma rate heterogeneity.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 10: The posterior support for including a proportion of invariant sites.</figcaption>
</figure>
<br>
...
<figure>
	...
	<figcaption>Figure 11: Correlations between rate parameters.</figcaption>
</figure>
<br>
